...
void main() {
  ...
  group('get Now Playing Tvs', () {
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/airing_today?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('tv/dummy_data/now_playing.json'), 200));
      // act
  ...
  group('get Popular Tvs', () {
    final tTvList =
        TvResponse.fromJson(json.decode(readJson('tv/dummy_data/popular.json')))
            .tvList;
    ...
    test('should return list of tvs when response is success (200)', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/popular?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('tv/dummy_data/popular.json'), 200));
      // act
  ...
  group('get Top Rated Tvs', () {
    final tTvList = TvResponse.fromJson(
            json.decode(readJson('tv/dummy_data/top_rated.json')))
        .tvList;
    ...
    test('should return list of tvs when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('tv/dummy_data/top_rated.json'), 200));
      // act
  ...
  group('get tv detail', () {
    ...
    final tTvDetail = TvDetailResponse.fromJson(
        json.decode(readJson('tv/dummy_data/tv_detail.json')));

    test('should return tv detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
          .thenAnswer((_) async => http.Response(
                  readJson('tv/dummy_data/tv_detail.json'), 200,
                  headers: {
  ...
  group('get tv recommendations', () {
    final tTvList = TvResponse.fromJson(
            json.decode(readJson('tv/dummy_data/tv_recommendations.json')))
        .tvList;
    final tId = 1;
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('tv/dummy_data/tv_recommendations.json'), 200));
      // act
  ...
  group('search tvs', () {
    final tSearchResult = TvResponse.fromJson(
            json.decode(readJson('tv/dummy_data/search_spiderman_tv.json')))
        .tvList;
    ...
    test('should return list of tvs when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('tv/dummy_data/search_spiderman_tv.json'), 200));
      // act
